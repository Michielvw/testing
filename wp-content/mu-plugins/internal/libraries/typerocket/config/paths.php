...
return [
    ...
    */
    'urls' => [
        'assets' => WPMU_PLUGIN_URL . '/internal/libraries/typerocket/wordpress/assets',
        'components' => WPMU_PLUGIN_URL . '/internal/libraries/typerocket/wordpress/assets/components',
    ],
